...
const UserForm = () => {
  ...
  return (
    ...
    <TextField
      ...
      />
      <Button style={{color: 'white', display: 'block', width: '100px', padding: '10px', borderRadius: '10px', fontSize: '14px', marginTop: '10px', background: 'linear-gradient(to right, #0000FF, #000033)' }}>Submit</Button>
    </div>
  );
};
