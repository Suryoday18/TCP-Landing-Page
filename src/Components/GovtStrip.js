...
const GovtStrip = () => {
  return (
    <Box sx={{ height: 180, display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'row', bgcolor: '#fff', color: 'black' }}>
        ...
        <div>
          <img src="http://www.ud.hp.gov.in/sites/default/files/inline-images/logo1.png" alt="image2" style={{ width: '90px', height: '90px', margin: '20px 40px 20px -20px' }} />
        </div>
          <div style={{display: 'flex', flexDirection: 'row', color: '#1F4A7C', width: '605px', height: 'auto', border: '7px solid #1F4A7C', position:'relative'}}>
