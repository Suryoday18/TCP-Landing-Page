  ...
  return (
    <Box sx={{ height: 180, display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'row', bgcolor: '#fff', color: 'black' }}>
        <Box sx={{ display: 'flex', flexDirection: 'row'}}>
          ...
          <div style={{display: 'flex', flexDirection: 'row', color: '#1F4A7C', width: '620px', height: 'auto', border: '7px solid #1F4A7C', position:'relative'}}>
          <div>
          ...
          <h4 style={{fontWeight: '30px', margin: '10px -135px', width: '125px', position: 'absolute', top: '-20px', backgroundColor: 'white'}}>हिमाचल प्रदेश सरकार</h4>
          ...
          <h6 style={{fontSize: '15.75px', color: '#154773',margin: '10px 10px 10px 195px', position: 'absolute', bottom:'-20px', backgroundColor: 'white'}}>Government of Himanchal Pardesh</h6>
          </div>
          </div>
        </Box>
