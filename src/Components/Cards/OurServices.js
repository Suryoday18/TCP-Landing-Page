...
const OurServices = () => {
  return (
    <div>
    <Card style={{maxWidth: 900, height: 350, background: 'linear-gradient(to right, #FFF5FF, #FFE5FF)', margin: '10px', boxShadow: 'rgba(50, 50, 93, 0.25) 0px 30px 60px -12px inset, rgba(0, 0, 0, 0.3) 0px 18px 36px -18px inset'}}>
      <CardContent>
        <Typography variant="h5" style={{ backgroundColor: "#800080", color: "white", padding: "10px", fontSize: '15px', borderRadius: '5px' }}>
          Our Services
        </Typography>
